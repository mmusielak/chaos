...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _fractals_triangle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fractals/triangle */ \"./src/fractals/triangle.js\");\n/* harmony import */ var _fractals_square__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fractals/square */ \"./src/fractals/square.js\");\n/* harmony import */ var _fractals_hexagon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fractals/hexagon */ \"./src/fractals/hexagon.js\");\n/* harmony import */ var _fractals_square_1__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fractals/square-1 */ \"./src/fractals/square-1.js\");\n/* harmony import */ var _fractals_square_diff__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fractals/square-diff */ \"./src/fractals/square-diff.js\");\n/* harmony import */ var _fractals_even_square__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./fractals/even-square */ \"./src/fractals/even-square.js\");\n/* harmony import */ var _fractals_pentagon_diff__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./fractals/pentagon-diff */ \"./src/fractals/pentagon-diff.js\");\n/* harmony import */ var _fractals_fern__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./fractals/fern */ \"./src/fractals/fern.js\");\n/* harmony import */ var _fractals_ngon__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./fractals/ngon */ \"./src/fractals/ngon.js\");\n/* harmony import */ var _fractals_triangle_ifs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./fractals/triangle-ifs */ \"./src/fractals/triangle-ifs.js\");\n// -- CONFIGURATION --\n\nvar counter = 0;\nvar limiter = 500000;\nvar iterations = 10000;\nvar resolution = 5;\n\n// -- PIXEL BUFFER --\n\nvar canvas = document.querySelector('canvas');\nvar context = canvas.getContext('2d');\n\ncanvas.width = 360 * resolution;\ncanvas.height = 240 * resolution;\ncontext.imageSmoothingEnabled = true;\n\nvar image = context.getImageData(0, 0, canvas.width, canvas.height);\nvar buffer = new ArrayBuffer(image.data.length);\nvar uint8 = new Uint8Array(buffer);\nvar uint32 = new Uint32Array(buffer);\n\n// paint it black (good for screenshots)\nfor (var i = 0; i < uint32.length; i++) {\n  uint32[i] = 0xFF000000;\n}\n\n// -- MODES --\n\n\n_fractals_triangle__WEBPACK_IMPORTED_MODULE_0__[\"default\"].init(canvas);\n\n_fractals_square__WEBPACK_IMPORTED_MODULE_1__[\"default\"].init(canvas);\n\n_fractals_hexagon__WEBPACK_IMPORTED_MODULE_2__[\"default\"].init(canvas);\n\n_fractals_square_1__WEBPACK_IMPORTED_MODULE_3__[\"default\"].init(canvas);\n\n_fractals_square_diff__WEBPACK_IMPORTED_MODULE_4__[\"default\"].init(canvas);\n\n_fractals_even_square__WEBPACK_IMPORTED_MODULE_5__[\"default\"].init(canvas);\n\n_fractals_pentagon_diff__WEBPACK_IMPORTED_MODULE_6__[\"default\"].init(canvas);\n\n_fractals_fern__WEBPACK_IMPORTED_MODULE_7__[\"default\"].init(canvas);\n\n_fractals_ngon__WEBPACK_IMPORTED_MODULE_8__[\"default\"].sides = 7;\n_fractals_ngon__WEBPACK_IMPORTED_MODULE_8__[\"default\"].init(canvas);\n\n\n_fractals_triangle_ifs__WEBPACK_IMPORTED_MODULE_9__[\"default\"].init(canvas);\n\nvar mode = 0;\nvar fractal = _fractals_triangle_ifs__WEBPACK_IMPORTED_MODULE_9__[\"default\"];\nvar fractals = [_fractals_triangle__WEBPACK_IMPORTED_MODULE_0__[\"default\"], _fractals_square__WEBPACK_IMPORTED_MODULE_1__[\"default\"], _fractals_fern__WEBPACK_IMPORTED_MODULE_7__[\"default\"], _fractals_ngon__WEBPACK_IMPORTED_MODULE_8__[\"default\"]];\n\nwindow.addEventListener('keydown', (e) => {\n  var delta = 0;\n  if (event.keyCode == 37) {\n    delta = -1;\n  }\n  if (event.keyCode == 39) {\n    delta = 1;\n  }\n  if (delta) {\n    mode = (fractals.length + mode + delta) % fractals.length;\n    fractal = fractals[mode];\n    fractal.init(canvas);\n    counter = 0;\n    for (var i = 0; i < uint32.length; i++) {\n      uint32[i] = 0xFF000000;\n    }\n  }\n});\n\n// -- LOOP --\n\nfunction animationFrame() {\n  for (var i = 0; i < iterations; i++) {\n    var cursor = fractal.iterate(canvas);\n    var color = HSVtoRGB(cursor.x / canvas.width, cursor.y / canvas.height, 0.75);\n\n    uint32[cursor.x + cursor.y * canvas.width] = color;\n  }\n\n  // update canvas\n  image.data.set(uint8);\n  context.putImageData(image, 0, 0);\n\n  // if limit was reached stop iterating\n  if ((counter += iterations) < limiter) {\n    requestAnimationFrame(animationFrame);\n  } else {\n    console.info(`${counter} pixels were drawn.`);\n  }\n}\n\nanimationFrame();\n\n// -- HELPERS --\n\nfunction HSVtoRGB(h, s, v) {\n  var i = h * 6 | 0;\n  var f = h * 6 - i;\n  var p = v * (1 - s);\n  var q = v * (1 - f * s);\n  var t = v * (1 - (1 - f) * s);\n  switch (i % 6) {\n  case 0: return 0xFF << 24 | v * 0xFF << 16 | t * 0xFF << 8 | p * 0xFF;\n  case 1: return 0xFF << 24 | q * 0xFF << 16 | v * 0xFF << 8 | p * 0xFF;\n  case 2: return 0xFF << 24 | p * 0xFF << 16 | v * 0xFF << 8 | t * 0xFF;\n  case 3: return 0xFF << 24 | p * 0xFF << 16 | q * 0xFF << 8 | v * 0xFF;\n  case 4: return 0xFF << 24 | t * 0xFF << 16 | p * 0xFF << 8 | v * 0xFF;\n  case 5: return 0xFF << 24 | v * 0xFF << 16 | p * 0xFF << 8 | q * 0xFF;\n  }\n}\n\n\n//# sourceURL=webpack:///./src/index.js?");
